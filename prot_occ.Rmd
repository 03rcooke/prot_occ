...
# occAssess for protected areas project
# Needs R >4.0.0
...
source('createData.R') # needed for adapted assessSpatialCov function
source('assessSpatialCov_adapt.R')
...
# number of records
# IS THIS USEFUL? ASK ROB B

nRec <- occAssess::assessRecordNumber(dat = all_obs,
                                      periods = periods,
                                      species = "species",
                                      x = "EASTING",
                                      y = "NORTHING",
